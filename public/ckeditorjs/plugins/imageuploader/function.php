...
function loadImages() {
    ...
    if(file_exists($useruploadpath)){
        ...
        $dir = $useruploadpath;
        $files = glob("$dir*.{jpg,jpe,jpeg,png,gif,ico,PNG,JPG,JPEG,GIF,ICO}", GLOB_BRACE);
        ...
        for($i=count($files)-1; $i >= 0; $i--):
           ...
           $image_url = 'https://questioncloud.in/MyAdmin/ckeditor/plugins/imageuploader/uploads/'.$image_basename;
