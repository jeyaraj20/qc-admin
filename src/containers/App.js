...
import SignInSchool from "./SignInSchool";
...
const App = (props) => {
  ...
  if (location.pathname === '/' ) {
    ...
    } else if (initURL === '' || initURL === '/' || initURL === '/signin' || initURL === '/insignin' || initURL === '/insignin/' ) {
      return ( <Redirect to={'/app/homedashboard/dashboard'}/> );
    } else {
      return ( <Redirect to={initURL}/> );
    }
  }

  if (location.pathname === '/insignin/' ) {
    if (authUser === null) {
      return ( <Redirect to={'/signin'}/> );
    } else if (initURL === '' || initURL === '/' || initURL === '/signin' || initURL === '/insignin' || initURL === '/insignin/' ) {
      return ( <Redirect to={'/app/homedashboard/dashboard'}/> );
