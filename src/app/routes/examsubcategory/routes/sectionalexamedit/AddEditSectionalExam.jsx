...
const AddEditSectionalExam = (props) => {
    ...
    //             totQuest = parseInt(totQuest) + parseInt(newArr[i].ques_ans);
    //         }
    //     }
    ...
    const handleRefresh = async () => {
        ...
        if (mode === 'Edit') {
            ...
            setTestTypes(typesListArr);
            setAutoSectionRow([
                { rowsNo: 1, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '', sect_time: '', tot_marks: '', addtype: true, deltype: false, btn: true, questionbank: [] }
            ]);
        }
    ...
    const saveSectionExam = async () => {
        ...
        setAlertMessage('Section Exam added successfully!');
        setShowMessage(true);
        setTimeout(() => {
    ...
    const updateSectionExamClick = async () => {
    ...
    const updateSectionExam = async () => {
        ...
        await examServices.updateSectionExam(examId, data);
        setAlertMessage('Section Exam Updated successfully!');
        setShowMessage(true);
        setTimeout(() => {
            setShowMessage(false)
        }, 1500);
                ...
                <div className="row no-gutters">
                    ...
                    <div style={{ padding: '1%' }} className="col-lg-12 d-flex flex-column order-lg-1">
                        ...
                        {mode === 'Add' ? <div style={{ paddingTop: '2%', textAlign: 'right' }} className="col-lg-6 col-sm-6 col-12">
                            <Button onClick={() => saveSectionExam()} variant="contained" color="primary" className="jr-btn text-white">
                                Submit
                            </Button>
                        </div> :
                            <div style={{ paddingTop: '2%', textAlign: 'right' }} className="col-lg-6 col-sm-6 col-12">
                                <Button onClick={() => updateSectionExamClick()} variant="contained" color="primary" className="jr-btn text-white">
                                    Update
                                </Button>
                            </div>
                        }
