...
const AddEditSectionalExam = (props) => {
    ...
    const [autosectionrow, setAutoSectionRow] = useState([
        { rowsNo: 1, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: true, deltype: true, btn: true, questionbank: [] },
        { rowsNo: 2, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: true, deltype: true, btn: true, questionbank: [] }
    ]);
    ...
    //         rowNum = rowNum + 1;
    //         const { rowsNo, menu_title, no_ofquest,ques_ans, mark_perquest, neg_mark, cut_off, sect_time, tot_marks, addtype, deltype } = row //destructuring
    //         return (
    ...
    //                 </div>
    //                 <div style={{ padding: '0.5%', textAlign: 'right' }} className="col-lg-1 d-flex flex-column order-lg-1">
    //                     <input value={ques_ans} onChange={(e) => onQuestAnsChange(e, index)} />
    //                 </div>
    //                 <div style={{ padding: '0.5%', textAlign: 'right' }} className="col-lg-1 d-flex flex-column order-lg-1">
    ...
    const renderAutomaticSectionRows = () => {
        ...
        return autosectionrow.map((row, index) => {
            ...
            rowNum = rowNum + 1;
            const { rowsNo, menu_title, no_ofquest, ques_ans, mark_perquest, neg_mark, cut_off, sect_time, tot_marks, addtype, deltype, btn, questionbank } = row //destructuring
            return (
                <>
                    <div key={index} className="row no-gutters">
                        <div style={{ padding: '0.5%', textAlign: 'right' }} className="col-lg-3 d-flex flex-column order-lg-1">
                        ...
                        <div style={{ padding: '0.5%', textAlign: 'right' }} className="col-lg-1 d-flex flex-column order-lg-1">
                            <input value={ques_ans} onChange={(e) => onAutoQuestAnsChange(e, index)} />
                        </div>
                        <div style={{ padding: '0.5%', textAlign: 'right' }} className="col-lg-1 d-flex flex-column order-lg-1">
    ...
    const onQuestAnsChange = (e, index) => {
        let newArr = [...sectionRow]; // copying the old datas array
        newArr[index].ques_ans = e.target.value; // replace e.target.value with whatever you want to change it to
    ...
    const onAutoQuestAnsChange = (e, index) => {
    ...
    const onMarkPerQuestChange = (e, index) => {
        ...
        if (newArr[index].no_ofquest != '') {
            newArr[index].tot_marks = e.target.value * newArr[index].ques_ans
        } else {
            newArr[index].tot_marks = e.target.value * 0
        }
        setSectionRow(newArr); // ??
        ...
        if (mode === 'Edit') {
            ...
            if(sectionres && sectionres.count > 0){
                for (let section of sectionRow) {
                    ...
                    sectionObj.ques_ans = section.ques_ans;
            ...
            setTestTypes(typesListArr);
            setSectionRow([
                { rowsNo: 1, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: true, deltype: false }
            ]);
        }
        setMode(examtype);
    ...
    const handleAddedExamTypes = (e) => {
        handleSectionalTiming(e);
        handleSectionalCutoff(e);
    ...
    const handleSectionalTiming = (e) => {
        setSectionalTiming("N");
    }

    const handleSectionalCutoff = (e) => {
        setSectionalCutoff("N");
    }
    ...
    const handleQuestionType = async (e) => {
        if (e.target.value === 'MANU') {
            setAutoSectionRow([
                { rowsNo: 1, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: true, deltype: false, btn: false, questionbank: [] },
        { rowsNo: 2, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: true, deltype: false, btn: false, questionbank: [] }
            ]);
        } else {
            setAutoSectionRow([
                { rowsNo: 1, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: true, deltype: false, btn: true, questionbank: [] },
                { rowsNo: 2, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: true, deltype: false, btn: true, questionbank: [] }
            ]);
        }
    ...
    const saveSectionExamClick = async () => {
    ...
    const saveSectionExam = async () => {
        ...
        if (validateSections()) {
            await examServices.saveSectionExam(data);
            setAlertMessage('Sectional Exam added successfully!');
            setShowMessage(true);
            setTimeout(() => {
                setShowMessage(false)
            }, 1500);
    ...
    const updateSectionExam = async () => {
        ...
        console.log(data);
        await examServices.updateSectionExam(examdetails.exam_id, data);
        setAlertMessage('Sectional Exam Updated successfully!');
        setShowMessage(true);
        setTimeout(() => {
            setShowMessage(false)
        }, 1500);
    ...
    const addSectionalRow = (index) => {
        let nextRow = { rowsNo: index, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: false, deltype: true };
    ...
    const addAutoSectionalRow = (index) => {
        ...
        let nextRow = [{ rowsNo: index, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: false, deltype: true, btn: true, questionbank: [] },
        { rowsNo: index+1, menu_title: '', no_ofquest: '',ques_ans:'', mark_perquest: '', neg_mark: '', cut_off: '0', sect_time: '0', tot_marks: '', addtype: false, deltype: true, btn: true, questionbank: [] }];
            ...
            {!loader &&
                <div className="row no-gutters">
                    ...
                    <div style={{ padding: '1%' }} className="col-lg-12 d-flex flex-column order-lg-1">
                        ...
                        <div className="row no-gutters">
                            <div style={{ textAlign: 'left' }} className="col-lg-3 d-flex flex-column order-lg-1">
                                Menu Title
                            </div>
                            <div style={{ textAlign: 'center' }} className="col-lg-1 d-flex flex-column order-lg-1">
                                No of Quest
                        ...
                        */}
                        ...
                        {mode === 'Add' ? <div style={{ paddingTop: '2%', textAlign: 'right' }} className="col-lg-6 col-sm-6 col-12">
                            <Button onClick={() => saveSectionExamClick()} disabled={submitDisabled} variant="contained" color="primary" className="jr-btn text-white">
                                Submit
                            </Button>
                        </div> :
                            <div style={{ paddingTop: '2%', textAlign: 'right' }} className="col-lg-6 col-sm-6 col-12">
                                <Button onClick={() => updateSectionExam()} variant="contained" color="primary" className="jr-btn text-white">
                                    Update
                                </Button>
                            </div>
                        }
...
export default AddEditSectionalExam;;
