...
const ExamView = (props) => {
    ...
    const handleRefresh = async () => {
        ...
        let { qidparams, modeparams, maincategoryparams,subcategoryparams } = props;
        let qid = qidparams;
        let mode = modeparams;
        setCategoryName(maincategoryparams);
        setSubCategoryName(subcategoryparams);
        ...
        <>
            {examview &&
                <div className="row no-gutters">
                    <div style={{ padding: '1%' }} className="col-lg-11 d-flex flex-column order-lg-1">
                        <h4>Exam View question for ({categoryname} - {subcategoryname})</h4>
                    </div>
            ...
            {view &&
                <>
                    <div className="row no-gutters">
                        <div style={{ padding: '1%' }} className="col-lg-11 d-flex flex-column order-lg-1">
                            <h4>View question for ({categoryname} - {subcategoryname})</h4>
                        </div>
                        <div style={{ padding: '1%' }} className="col-lg-1 d-flex flex-column order-lg-1">
                            <Button onClick={() => handleClose()} variant="contained" color="primary" className="jr-btn">
                                <i className="zmdi zmdi-close zmdi-hc-fw" />
